...
if (isset($_POST['nome_tarefa'])) {
    ...
    //função para verificar se algo está dentro de um array
    ...
    } else if ($duracao_minutos <= 0) { // Já pega negativos e o zero de uma vez só!
    ...
    if (empty($msgs)) {
        ...
        $stm->execute([$nome_tarefa, $categoria, $duracao_minutos, $prioridade, $data_entrega]);
